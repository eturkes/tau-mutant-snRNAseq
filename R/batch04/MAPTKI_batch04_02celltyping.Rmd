---
title: "MAPT KI - Batch 04 - 02 Cell-typing"
author:
  - name: "Emir Turkes"
...
knit: (function(inputFile, encoding) {
  rmarkdown::render(
    ...
    output_file = file.path(
      "..", "..", "results", "batch04", "MAPTKI_batch04_02celltyping.html"
    ))})
---
...
seurat <- RenameIdents(
  ...
  "1" = "Astrocyte", "2" = "Hippocampal Glutamatergic",
  "3" = "Cortical Glutamatergic", "4" = "Oligodendrocyte",
  "5" = "Hippocampal Glutamatergic", "6" = "Microglia",
  "7" = "Cortical Glutamatergic", "8" = "Cortical Glutamatergic",
  "9" = "Hippocampal Glutamatergic", "10" = "GABAergic",
  "11" = "Cortical Glutamatergic", "12" = "Cortical Glutamatergic",
  "13" = "OPC", "14" = "Vascular",
  "15" = "GABAergic", "16" = "Cortical Glutamatergic",
  "17" = "Cortical Glutamatergic", "18" = "Cortical Glutamatergic",
  "19" = "Vascular", "20" = "Cortical Glutamatergic",
  "21" = "Cortical Glutamatergic", "22" = "Vascular",
