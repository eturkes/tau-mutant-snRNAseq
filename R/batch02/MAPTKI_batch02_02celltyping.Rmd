---
title: "MAPT KI - Batch 02 - 02 Cell-typing"
author:
  - name: "Emir Turkes"
...
knit: (function(inputFile, encoding) {
  rmarkdown::render(
    ...
    output_file = file.path(
      "..", "..", "results", "batch02", "MAPTKI_batch02_02celltyping.html"
    ))})
---
...
seurat <- RenameIdents(
  ...
  "1" = "Cortical Glutamatergic", "2" = "Astrocyte",
  "3" = "Hippocampal Glutamatergic", "4" = "GABAergic",
  "5" = "Hippocampal Glutamatergic", "6" = "Microglia",
  "7" = "Cortical Glutamatergic", "8" = "Cortical Glutamatergic",
  "9" = "Vascular", "10" = "Hippocampal Glutamatergic",
