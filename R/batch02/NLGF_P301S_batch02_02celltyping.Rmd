---
title: "NLGF P301S+3 - Batch 02 - 02 Cell-typing"
author:
  - name: "Emir Turkes"
...
knit: (function(inputFile, encoding) {
  rmarkdown::render(
    ...
    output_file = file.path(
      "..", "..", "results", "batch02", "NLGF_P301S_batch02_02celltyping.html"
    ))})
---
...
seurat <- RenameIdents(
  ...
  "3" = "Astrocyte", "4" = "Cortical Glutamatergic",
  "5" = "Cortical Glutamatergic", "6" = "Cortical Glutamatergic",
  "7" = "Hippocampal Glutamatergic", "8" = "OPC",
  "9" = "Hippocampal Glutamatergic", "10" = "Cortical Glutamatergic",
  "11" = "GABAergic", "12" = "Cortical Glutamatergic",
  "13" = "Unknown", "14" = "GABAergic",
  "15" = "Hippocampal Glutamatergic", "16" = "Vascular",
  "17" = "Vascular", "18" = "Cortical Glutamatergic",
