...
results_sub <- results_sub[order(rowSums(results_sub[ , c(4, 6)])), ]
results_sub_up <- results_sub[
  results_sub[ , 1] > 0 & results_sub[ , 3] > 0,
]
if (nrow(results_sub_up) > 0) {
  if (nrow(results_sub_up) > size)
...
results_sub <- results_sub[order(rowSums(results_sub[ , c(4, 5)])), ]
results_sub_up <- results_sub[
  results_sub[ , 1] > 0 & results_sub[ , 2] > 0,
]
if (nrow(results_sub_up) > 0) {
...
results_sub <- results_sub[order(rowSums(results_sub[ , c(5, 6)])), ]
results_sub_up <- results_sub[
...
row_split <- factor(
  c(
    ...
    rep(
      "NLGF MAPTKI\nNLGF S305N",
      times = ifelse(
        is.null(nrow(results_up[[7]])), yes = 0, no = nrow(results_up[[7]])
      )
    ),
    rep(
      "NLGF MAPTKI\nNLGF S305N\nNLGF P301S",
      times = ifelse(
        is.null(nrow(results_up[[8]])), yes = 0, no = nrow(results_up[[8]])
      )
    ),
    rep(
      "NLGF S305N\nNLGF P301S",
      times = ifelse(
        is.null(nrow(results_up[[9]])), yes = 0, no = nrow(results_up[[9]])
      )
    ),
    rep(
      "NLGF P301S",
...
row_split <- factor(
  c(
    ...
    rep(
      "NLGF MAPTKI\nNLGF S305N",
      times = ifelse(
        is.null(nrow(results_down[[7]])), yes = 0, no = nrow(results_down[[7]])
      )
    ),
    rep(
      "NLGF MAPTKI\nNLGF S305N\nNLGF P301S",
      times = ifelse(
        is.null(nrow(results_down[[8]])), yes = 0, no = nrow(results_down[[8]])
      )
    ),
    rep(
      "NLGF S305N\nNLGF P301S",
      times = ifelse(
        is.null(nrow(results_down[[9]])), yes = 0, no = nrow(results_down[[9]])
      )
    ),
    rep(
      "NLGF P301S",
