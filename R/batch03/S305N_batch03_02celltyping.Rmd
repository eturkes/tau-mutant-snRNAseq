---
title: "S305N+3 - Batch 03 - 02 Cell-typing"
author:
  - name: "Emir Turkes"
...
knit: (function(inputFile, encoding) {
  rmarkdown::render(
    ...
    output_file = file.path(
      "..", "..", "results", "batch03", "S305N_batch03_02celltyping.html"
    ))})
---
...
seurat <- RenameIdents(
  ...
  "1" = "Astrocyte", "2" = "Cortical Glutamatergic",
  "3" = "Hippocampal Glutamatergic", "4" = "Cortical Glutamatergic",
  "5" = "Microglia", "6" = "Hippocampal Glutamatergic",
  "7" = "Cortical Glutamatergic", "8" = "GABAergic",
  "9" = "Cortical Glutamatergic", "10" = "Cortical Glutamatergic",
  "11" = "Vascular", "12" = "Cortical Glutamatergic",
  "13" = "Hippocampal Glutamatergic", "14" = "OPC",
  "15" = "GABAergic", "16" = "Hippocampal Glutamatergic",
  "17" = "Hippocampal Glutamatergic", "18" = "Unknown",
  "19" = "Cortical Glutamatergic", "20" = "Unknown",
  "21" = "Cortical Glutamatergic", "22" = "Cortical Glutamatergic",
