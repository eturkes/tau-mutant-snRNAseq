---
title: "MAPT KI - Batch 03 - 02 Cell-typing"
author:
  - name: "Emir Turkes"
...
knit: (function(inputFile, encoding) {
  rmarkdown::render(
    ...
    output_file = file.path(
      "..", "..", "results", "batch03", "MAPTKI_batch03_02celltyping.html"
    ))})
---
...
seurat <- RenameIdents(
  ...
  "1" = "Hippocampal Glutamatergic", "2" = "Oligodendrocyte",
  "3" = "Cortical Glutamatergic", "4" = "Cortical Glutamatergic",
  "5" = "Microglia", "6" = "Oligodendrocyte",
  "7" = "Hippocampal Glutamatergic", "8" = "Cortical Glutamatergic",
  "9" = "GABAergic", "10" = "Cortical Glutamatergic",
  "11" = "Cortical Glutamatergic", "12" = "Cortical Glutamatergic",
  "13" = "Vascular", "14" = "GABAergic",
  "15" = "OPC", "16" = "Hippocampal Glutamatergic",
  "17" = "Cortical Glutamatergic", "18" = "Cortical Glutamatergic",
  "19" = "Cortical Glutamatergic", "20" = "Cortical Glutamatergic",
  "21" = "Vascular", "22" = "Vascular",
  "23" = "Unknown", "24" = "Vascular",
