...
knit: (function(inputFile, encoding) {
  rmarkdown::render(
    ...
    output_file = file.path(
      "..", "..", "results", "batch4", "NLGF_MAPTKI_batch04_01prep.html"
    ))})
---
...
data_dir <- file.path(
  "..", "..", "data", "external", "tau-mutant-snRNAseq", "starsolo",
  "batch3_4", "LogFiles", "NWB4_3Solo.out", "Gene", "raw"
)
cache_dir <- file.path(
  "..", "..", "cache",
...
seurat <- subset(
  seurat,
  subset = nFeature_RNA >= 475 & nCount_RNA >= 550 & nFeature_RNA < 4000 &
    nCount_RNA < 10000 & percent_mt < 5 & percent_ribo < 10
)
seurat
