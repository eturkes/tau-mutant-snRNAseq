---
title: "NLGF MAPT KI - Batch 04 - 02 Cell-typing"
author:
  - name: "Emir Turkes"
...
knit: (function(inputFile, encoding) {
  rmarkdown::render(
    ...
    output_file = file.path(
      "..", "..", "results", "batch04", "NLGF_MAPTKI_batch04_02celltyping.html"
    ))})
---
...
seurat <- RenameIdents(
  object = seurat, "0" = "Microglia",
  "1" = "Oligodendrocyte", "2" = "Oligodendrocyte",
  "3" = "Hippocampal Glutamatergic", "4" = "Unknown",
  "5" = "Hippocampal Glutamatergic", "6" = "Astrocyte",
  "7" = "Cortical Glutamatergic", "8" = "Unknown",
  "9" = "Cortical Glutamatergic", "10" = "GABAergic",
  "11" = "Oligodendrocyte", "12" = "Microglia",
  "13" = "Cortical Glutamatergic", "14" = "Hippocampal Glutamatergic",
  "15" = "Cortical Glutamatergic", "16" = "OPC",
  "17" = "Cortical Glutamatergic", "18" = "GABAergic",
  "19" = "Vascular", "20" = "Unknown",
  "21" = "Unknown", "22" = "Vascular",
  "23" = "Unknown", "24" = "Cortical Glutamatergic",
  "25" = "Unknown", "26" = "Cortical Glutamatergic",
  "27" = "Unknown", "28" = "Cortical Glutamatergic",
  "29" = "Cortical Glutamatergic", "30" = "Unknown",
  "31" = "Cortical Glutamatergic"
)
