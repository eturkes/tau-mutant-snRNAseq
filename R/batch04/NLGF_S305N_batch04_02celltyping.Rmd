---
title: "NLGF S305N+3 - Batch 04 - 02 Cell-typing"
author:
  - name: "Emir Turkes"
...
knit: (function(inputFile, encoding) {
  rmarkdown::render(
    ...
    output_file = file.path(
      "..", "..", "results", "batch04", "NLGF_S305N_batch04_02celltyping.html"
    ))})
---
...
seurat <- RenameIdents(
  ...
  "3" = "Cortical Glutamatergic", "4" = "Astrocyte",
  "5" = "Hippocampal Glutamatergic", "6" = "Cortical Glutamatergic",
  "7" = "Unknown", "8" = "Cortical Glutamatergic",
  "9" = "OPC", "10" = "Hippocampal Glutamatergic",
  "11" = "Hippocampal Glutamatergic", "12" = "GABAergic",
  "13" = "Vascular", "14" = "Vascular",
