...
results_up <- vector("list", length = 6)
results_down <- vector("list", length = 6)
size <- 10

results_sub <- results[ , c(2, 3, 12, 13, 17, 18)]
results_sub <- results_sub[
  results_sub[ , 5] < 0.05 & results_sub[ , 6] < 0.05,
]
results_sub <- results_sub[order(rowSums(results_sub[ , c(3, 4)])), ]
results_sub_up <- results_sub[
  results_sub[ , 1] > 0 & results_sub[ , 2] > 0,
]
...
results_sub <- results_sub[order(results_sub[ , 3]), ]
results_sub_up <- results_sub[
  results_sub[ , 1] > 0,
]
if (nrow(results_sub_up) > 0) {
...
results_sub <- results_sub[order(results_sub[ , 4]), ]
results_sub_up <- results_sub[
  results_sub[ , 2] > 0,
]
if (nrow(results_sub_up) > 0) {
...
results_sub <- results[ , c(4, 5, 6, 14, 15, 16, 19, 20, 21)]
results_sub <- results_sub[
  results_sub[ , 7] < 0.05 & results_sub[ , 8] < 0.05 &
    results_sub[ , 9] < 0.05,
]
results_sub <- results_sub[order(rowSums(results_sub[ , c(4, 5, 6)])), ]
results_sub_up <- results_sub[
  results_sub[ , 1] > 0 & results_sub[ , 2] > 0 & results_sub[ , 3] > 0,
]
if (nrow(results_sub_up) > 0) {
  if (nrow(results_sub_up) > size)
...
results_sub <- results_sub[order(results_sub[ , 5]), ]
results_sub_up <- results_sub[
  results_sub[ , 2] > 0,
]
if (nrow(results_sub_up) > 0) {
...
results_sub <- results_sub[order(results_sub[ , 6]), ]
results_sub_up <- results_sub[
  results_sub[ , 3] > 0,
]
if (nrow(results_sub_up) > 0) {
...
row_split <- factor(
  c(
    rep(
      "(2 & 3) > 1",
      times = ifelse(
        is.null(nrow(results_up[[1]])), yes = 0, no = nrow(results_up[[1]])
      )
    ),
    rep(
      "2 > 1 (3 null)",
      times = ifelse(
        is.null(nrow(results_up[[2]])), yes = 0, no = nrow(results_up[[2]])
      )
    ),
    rep(
      "3 > 1 (2 null)",
      times = ifelse(
        is.null(nrow(results_up[[3]])), yes = 0, no = nrow(results_up[[3]])
      )
    ),
    rep(
      "(4 & 5 & 6) > (1 & 2 & 3)",
      times = ifelse(
        is.null(nrow(results_up[[4]])), yes = 0, no = nrow(results_up[[4]])
      )
    ),
    rep(
      "5 > 2 (4 & 6 null)",
      times = ifelse(
        is.null(nrow(results_up[[5]])), yes = 0, no = nrow(results_up[[5]])
      )
    ),
    rep(
      "6 > 3 (4 & 5 null)",
      times = ifelse(
        is.null(nrow(results_up[[6]])), yes = 0, no = nrow(results_up[[6]])
      )
    )
  ),
  levels = c(
    "(2 & 3) > 1", "2 > 1 (3 null)", "3 > 1 (2 null)",
    "(4 & 5 & 6) > (1 & 2 & 3)", "5 > 2 (4 & 6 null)", "6 > 3 (4 & 5 null)"
  )
)
...
row_split <- factor(
  c(
    rep(
      "(2 & 3) > 1",
      times = ifelse(
        is.null(nrow(results_down[[1]])), yes = 0, no = nrow(results_down[[1]])
      )
    ),
    rep(
      "2 > 1 (3 null)",
      times = ifelse(
        is.null(nrow(results_down[[2]])), yes = 0, no = nrow(results_down[[2]])
      )
    ),
    rep(
      "3 > 1 (2 null)",
      times = ifelse(
        is.null(nrow(results_down[[3]])), yes = 0, no = nrow(results_down[[3]])
      )
    ),
    rep(
      "(4 & 5 & 6) > (1 & 2 & 3)",
      times = ifelse(
        is.null(nrow(results_down[[4]])), yes = 0, no = nrow(results_down[[4]])
      )
    ),
    rep(
      "5 > 2 (4 & 6 null)",
      times = ifelse(
        is.null(nrow(results_down[[5]])), yes = 0, no = nrow(results_down[[5]])
      )
    ),
    rep(
      "6 > 3 (4 & 5 null)",
      times = ifelse(
        is.null(nrow(results_down[[6]])), yes = 0, no = nrow(results_down[[6]])
      )
    )
  ),
  levels = c(
...
results_sub <- results[ , c(2, 3, 12, 13, 17, 18, 23)]
results_sub <- results_sub[
  results_sub[ , 5] < 0.05 & results_sub[ , 6] < 0.05,
]
results_sub <- results_sub[order(rowSums(results_sub[ , c(3, 4)])), ]
...
results_sub <- results[ , c(4, 5, 6, 14, 15, 16, 19, 20, 21, 23)]
results_sub <- results_sub[
  results_sub[ , 7] < 0.05 & results_sub[ , 8] < 0.05 &
    results_sub[ , 9] < 0.05,
]
