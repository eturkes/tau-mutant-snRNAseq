---
title: "S305N+3 - Batch 04 - 02 Cell-typing"
author:
  - name: "Emir Turkes"
...
knit: (function(inputFile, encoding) {
  rmarkdown::render(
    ...
    output_file = file.path(
      "..", "..", "results", "batch04", "S305N_batch04_02celltyping.html"
    ))})
---
...
seurat <- RenameIdents(
  object = seurat, "0" = "Astrocyte",
  "1" = "Cortical Glutamatergic", "2" = "Hippocampal Glutamatergic",
  "3" = "Oligodendrocyte", "4" = "GABAergic",
  "5" = "Cortical Glutamatergic", "6" = "Microglia",
  "7" = "Oligodendrocyte", "8" = "OPC",
  "9" = "Hippocampal Glutamatergic", "10" = "Cortical Glutamatergic",
  "11" = "Cortical Glutamatergic", "12" = "Hippocampal Glutamatergic",
  "13" = "Vascular", "14" = "Unknown",
  "15" = "Cortical Glutamatergic", "16" = "Cortical Glutamatergic",
  "17" = "GABAergic", "18" = "Unknown",
  "19" = "Cortical Glutamatergic", "20" = "Vascular",
  "21" = "Hippocampal Glutamatergic", "22" = "Cortical Glutamatergic",
  "23" = "Vascular", "24" = "Unknown",
  "25" = "Cortical Glutamatergic", "26" = "Cortical Glutamatergic",
  "27" = "Unknown", "28" = "Unknown",
  "29" = "Unknown", "30" = "Cortical Glutamatergic"
)
