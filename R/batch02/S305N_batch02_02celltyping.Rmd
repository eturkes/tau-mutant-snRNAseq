---
title: "S305N+3 - Batch 02 - 02 Cell-typing"
author:
  - name: "Emir Turkes"
...
knit: (function(inputFile, encoding) {
  rmarkdown::render(
    ...
    output_file = file.path(
      "..", "..", "results", "batch02", "S305N_batch02_02celltyping.html"
    ))})
---
...
seurat <- RenameIdents(
  ...
  "3" = "Cortical Glutamatergic", "4" = "Hippocampal Glutamatergic",
  "5" = "Oligodendrocyte", "6" = "Cortical Glutamatergic",
  "7" = "Microglia", "8" = "Cortical Glutamatergic",
  "9" = "Hippocampal Glutamatergic", "10" = "Vascular",
  "11" = "GABAergic", "12" = "Cortical Glutamatergic",
  "13" = "Cortical Glutamatergic", "14" = "Cortical Glutamatergic",
  "15" = "OPC", "16" = "GABAergic",
  "17" = "Hippocampal Glutamatergic", "18" = "Cortical Glutamatergic",
  "19" = "Unknown", "20" = "Cortical Glutamatergic",
  "21" = "Unknown", "22" = "Vascular",
  "23" = "Cortical Glutamatergic", "24" = "Unknown",
  "25" = "Cortical Glutamatergic", "26" = "Unknown"
)
