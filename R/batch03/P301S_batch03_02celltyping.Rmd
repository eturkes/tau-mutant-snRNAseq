---
title: "P301S+3 - Batch 03 - 02 Cell-typing"
author:
  - name: "Emir Turkes"
...
knit: (function(inputFile, encoding) {
  rmarkdown::render(
    ...
    output_file = file.path(
      "..", "..", "results", "batch03", "P301S_batch03_02celltyping.html"
    ))})
---
...
seurat <- RenameIdents(
  ...
  "3" = "Astrocyte", "4" = "Microglia",
  "5" = "Hippocampal Glutamatergic", "6" = "Cortical Glutamatergic",
  "7" = "Oligodendrocyte", "8" = "Hippocampal Glutamatergic",
  "9" = "Hippocampal Glutamatergic", "10" = "Vascular",
  "11" = "Cortical Glutamatergic", "12" = "GABAergic",
  "13" = "Unknown", "14" = "OPC",
  "15" = "GABAergic", "16" = "Hippocampal Glutamatergic",
  "17" = "Cortical Glutamatergic", "18" = "Hippocampal Glutamatergic",
  "19" = "Cortical Glutamatergic", "20" = "Vascular",
  "21" = "Vascular", "22" = "Cortical Glutamatergic",
