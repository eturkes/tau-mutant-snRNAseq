---
title: "NLGF MAPT KI - Batch 03 - 02 Cell-typing"
author:
  - name: "Emir Turkes"
...
knit: (function(inputFile, encoding) {
  rmarkdown::render(
    ...
    output_file = file.path(
      "..", "..", "results", "batch03", "NLGF_MAPTKI_batch03_02celltyping.html"
    ))})
---
...
seurat <- RenameIdents(
  ...
  "1" = "Astrocyte", "2" = "Oligodendrocyte",
  "3" = "Cortical Glutamatergic", "4" = "Microglia",
  "5" = "Hippocampal Glutamatergic", "6" = "Hippocampal Glutamatergic",
  "7" = "Cortical Glutamatergic", "8" = "GABAergic",
  "9" = "OPC", "10" = "Vascular",
  "11" = "Microglia", "12" = "Microglia",
  "13" = "Hippocampal Glutamatergic", "14" = "Cortical Glutamatergic",
  "15" = "Cortical Glutamatergic", "16" = "Cortical Glutamatergic",
  "17" = "Unknown", "18" = "Vascular",
  "19" = "GABAergic", "20" = "Unknown",
  "21" = "Cortical Glutamatergic", "22" = "GABAergic",
  "23" = "Cortical Glutamatergic", "24" = "Unknown",
  "25" = "Unknown", "26" = "Cortical Glutamatergic",
  "27" = "Cortical Glutamatergic"
)
