...
priority <- c(
  "tau", "neurofi", "amyloid", "heparan", "chondroitin", "synap",
  "inflammatory", "macrophage", "T cell", "B cell", "death", "phagy", "cytosis",
  "apopto", "fold",  "chemokine", "interleukin", "MHC", "lipid", "lipo",
  "kinase", "clearance"
)
# -----------------
```
