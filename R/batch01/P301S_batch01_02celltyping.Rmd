---
title: "P301S+3 - Batch 01 - 02 Cell-typing"
author:
  - name: "Emir Turkes"
...
knit: (function(inputFile, encoding) {
  rmarkdown::render(
    ...
    output_file = file.path(
      "..", "..", "results", "batch01", "P301S_batch01_02celltyping.html"
    ))})
---
...
seurat <- RenameIdents(
  ...
  "3" = "Hippocampal Glutamatergic", "4" = "Hippocampal Glutamatergic",
  "5" = "Cortical Glutamatergic", "6" = "Cortical Glutamatergic",
  "7" = "Cortical Glutamatergic", "8" = "Unknown",
  "9" = "Hippocampal Glutamatergic", "10" = "OPC",
  "11" = "Vascular", "12" = "Microglia",
  "13" = "GABAergic", "14" = "GABAergic",
  "15" = "Vascular", "16" = "GABAergic",
  "17" = "Cortical Glutamatergic", "18" = "Cortical Glutamatergic",
  "19" = "GABAergic", "20" = "Cortical Glutamatergic",
