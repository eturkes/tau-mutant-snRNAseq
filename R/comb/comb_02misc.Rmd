...
packages <- c(
  "Seurat", "DT", "dplyr", "ggplot2", "patchwork", "openxlsx", "htmltools"
)
invisible(
...
```{r, results = "asis"}
ctypes <- unique(seurat$broad_annotations)
...
if (file.exists(rds)) {
  ...
  seurat_raw$broad_annotations <- seurat$broad_annotations
  seurat_raw@active.ident <- seurat_raw$broad_annotations
