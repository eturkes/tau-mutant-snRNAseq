---
title: "S305N+3 - Batch 01 - 02 Cell-typing"
author:
  - name: "Emir Turkes"
...
knit: (function(inputFile, encoding) {
  rmarkdown::render(
    ...
    output_file = file.path(
      "..", "..", "results", "batch01", "S305N_batch01_02celltyping.html"
    ))})
---
...
seurat <- RenameIdents(
  ...
  "7" = "Vascular", "8" = "Cortical Glutamatergic",
  "9" = "Cortical Glutamatergic", "10" = "Microglia",
  "11" = "OPC", "12" = "Cortical Glutamatergic",
  "13" = "Hippocampal Glutamatergic", "14" = "GABAergic",
  "15" = "Cortical Glutamatergic", "16" = "Vascular",
