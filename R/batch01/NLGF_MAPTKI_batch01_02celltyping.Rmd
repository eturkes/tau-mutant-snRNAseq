---
title: "NLGF MAPT KI - Batch 01 - 02 Cell-typing"
author:
  - name: "Emir Turkes"
...
knit: (function(inputFile, encoding) {
  rmarkdown::render(
    ...
    output_file = file.path(
      "..", "..", "results", "batch01", "NLGF_MAPTKI_batch01_02celltyping.html"
    ))})
---
...
data_dir <- file.path(
  ...
  "cellranger", "batch1", "NWR03", "outs", "raw_feature_bc_matrix"
)
cache_dir <- file.path(
  "..", "..", "cache",
...
seurat <- RenameIdents(
  ...
  "3" = "Hippocampal Glutamatergic", "4" = "Microglia",
  "5" = "GABAergic", "6" = "Hippocampal Glutamatergic",
  "7" = "Astrocyte", "8" = "Cortical Glutamatergic",
  "9" = "Cortical Glutamatergic", "10" = "Hippocampal Glutamatergic",
  "11" = "OPC", "12" = "Vascular",
  "13" = "Cortical Glutamatergic", "14" = "Cortical Glutamatergic",
  "15" = "Cortical Glutamatergic", "16" = "Unknown",
  "17" = "Unknown", "18" = "Unknown",
  "19" = "Cortical Glutamatergic"
)
