---
title: "P301S+3 - Batch 04 - 02 Cell-typing"
author:
  - name: "Emir Turkes"
...
knit: (function(inputFile, encoding) {
  rmarkdown::render(
    ...
    output_file = file.path(
      "..", "..", "results", "batch04", "P301S_batch04_02celltyping.html"
    ))})
---
...
seurat <- RenameIdents(
  ...
  "3" = "Microglia", "4" = "Hippocampal Glutamatergic",
  "5" = "Cortical Glutamatergic", "6" = "Vascular",
  "7" = "Oligodendrocyte", "8" = "Hippocampal Glutamatergic",
  "9" = "Cortical Glutamatergic", "10" = "Cortical Glutamatergic",
  "11" = "OPC", "12" = "GABAergic",
  "13" = "Cortical Glutamatergic", "14" = "GABAergic",
  "15" = "Hippocampal Glutamatergic", "16" = "Cortical Glutamatergic",
