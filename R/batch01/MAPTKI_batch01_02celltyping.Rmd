---
title: "MAPT KI - Batch 01 - 02 Cell-typing"
author:
  - name: "Emir Turkes"
...
knit: (function(inputFile, encoding) {
  rmarkdown::render(
    ...
    output_file = file.path(
      "..", "..", "results", "batch01", "MAPTKI_batch01_02celltyping.html"
    ))})
---
...
seurat <- RenameIdents(
  ...
  "1" = "Cortical Glutamatergic", "2" = "Oligodendrocyte",
  "3" = "Hippocampal Glutamatergic", "4" = "Cortical Glutamatergic",
  "5" = "Hippocampal Glutamatergic", "6" = "Cortical Glutamatergic",
  "7" = "GABAergic", "8" = "Cortical Glutamatergic",
  "9" = "Cortical Glutamatergic", "10" = "OPC",
  "11" = "GABAergic", "12" = "Vascular",
  "13" = "Hippocampal Glutamatergic", "14" = "Cortical Glutamatergic",
  "15" = "Vascular", "16" = "Microglia",
  "17" = "Cortical Glutamatergic", "18" = "Cortical Glutamatergic",
  "19" = "Cortical Glutamatergic", "20" = "Unknown",
  "21" = "Cortical Glutamatergic", "22" = "Unknown",
